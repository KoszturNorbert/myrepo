...
import hu.norbisan.jpa.pizzafx.business.converter.AddressConverter;
...
public class AddressServiceImpl implements AddressService {
	...
	public AddressVO saveAddress(AddressVO address) {
		return converter.toVO(addressDao.create(converter.toEntity(address)));
	}

	@Override
	public AddressVO findAddressById(Long id) {
		return converter.toVO(addressDao.findOne(id));
	}
